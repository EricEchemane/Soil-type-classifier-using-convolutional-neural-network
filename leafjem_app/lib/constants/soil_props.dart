const soilProps = [
  {
    ...
    "How to improve the soil":
        "add organic matters that are high porosity. cultivation",
    "Suitable Plants": "Majority of vegetables"
  },
  {
    "name": "sandy",
    "Overview":
        "Soil is light, warm, dry and tends to be acidic and low in nutrients. Sandy soils are often known as light soils due to their high proportion of sand and little clay (clay weighs more than sand). These soils have quick water drainage and are easy to work with.",
    ...
    "How to improve the soil":
        "add organic matters that can hold and retain water",
  ...
  },
  {
    "name": "gravel",
    "Overview":
        "Rocky or gravelly soil: Gravel is very small, irregular pieces of rock and stone. It is more rough and rocky than sand, and smaller than stones. Soil that is rocky or gravelly will have a large proportion of rocks or gravel. Loam: Loam is generally the type of soil that gardeners love.",
    "Colors": "dark brown, black",
  ...
  },
  {
    ...
    "How to verify the type":
        "has evident chunks of soil, small rocks mixed with sand",
    "Water and Nutrient Holding Capacity": "low",
    "Porosity": "low",
  ...
  },
  {
    "name": "grassy",
    "Overview":
        "It is nutrient-rich from the growth and decay of deep, many-branched grass roots. The rotted roots hold the soil together and provide a food source for living plants.",
    "Colors": "dark grey, grey, brown",
